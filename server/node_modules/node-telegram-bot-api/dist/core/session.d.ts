 ...
 */
export declare const SESSION_STATE_KEY = "session";
/**
 ...
 */
export declare function createSession<T = Record<string, unknown>>(options: SessionOptions<T>): SessionMiddleware<T>;
/** Alias for {@link createSession} - `bot.use(session({ store }))` reads naturally. */
export declare const session: typeof createSession;
