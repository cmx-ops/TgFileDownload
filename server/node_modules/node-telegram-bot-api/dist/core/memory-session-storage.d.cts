 ...
 */
import type { SessionStore, SessionWriteOptions } from "./session.cjs";
export declare class MemorySessionStorage implements SessionStore {
...
//# sourceMappingURL=memory-session-storage.d.cts.map