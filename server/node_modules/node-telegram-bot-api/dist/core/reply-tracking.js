...
function touch(ctx) {
    ...
    const state = handle.ext(REPLY_NAMESPACE, () => ({ replies: {}, presses: {} }), (slot) => isTable(slot.replies) && isTable(slot.presses));
 ...
 */
export function expectReply(ctx, messageId, marker = {}, options) {
 ...
 */
export function matchReply(ctx) {
...
export function forgetReply(ctx, messageId) {
 ...
 */
export function expectCallback(ctx, messageId, marker = {}, options) {
    const { state, config, now } = touch(ctx);
 ...
 */
export function matchCallback(ctx, options) {
...
export function forgetCallback(ctx, messageId) {
 ...
 */
export function taggedReplies(ctx) {
    return {
...
//# sourceMappingURL=reply-tracking.js.map