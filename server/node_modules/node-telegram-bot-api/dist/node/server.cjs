...
exports.gracefulClose = gracefulClose;
...
const signals_js_1 = require("./signals.cjs");
 ...
 */
function gracefulClose(server, timeoutMs) {
...
async function startWebhook(bot, options) {
    ...
    try {
        await (0, signals_js_1.withShutdownSignals)(stop, () => new Promise((resolve, reject) => {
            server.once("error", reject);
