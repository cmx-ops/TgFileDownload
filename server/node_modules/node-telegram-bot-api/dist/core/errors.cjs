...
exports.TelegramApiError = exports.ParseError = exports.TimeoutError = exports.NetworkError = exports.TelegramBotError = exports.HTTP_STATUS_CONFLICT = exports.HTTP_STATUS_TOO_MANY_REQUESTS = void 0;
exports.isAbortError = isAbortError;
exports.isTransientError = isTransientError;
exports.isPollConflict = isPollConflict;
/**
...
class NetworkError extends TelegramBotError {
    constructor(message, options = {}) {
...
class TimeoutError extends TelegramBotError {
...
class ParseError extends TelegramBotError {
    responseText;
    constructor(message, options = {}) {
...
class TelegramApiError extends TelegramBotError {
    errorCode;
    description;
    parameters;
...
function isTransientError(err) {
    ...
    if (err instanceof TelegramApiError) {
        return err.errorCode === exports.HTTP_STATUS_TOO_MANY_REQUESTS || err.errorCode >= 500;
    }
    return false;
}
/**
 ...
 */
function isPollConflict(err) {
    return err instanceof TelegramApiError && err.errorCode === exports.HTTP_STATUS_CONFLICT;
}
