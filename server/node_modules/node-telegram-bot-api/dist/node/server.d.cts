...
import type { WebhookOptions } from "../core/webhook.cjs";
 ...
 */
export declare function gracefulClose(server: http.Server, timeoutMs: number): ReturnType<typeof setTimeout>;
/**
