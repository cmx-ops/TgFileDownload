...
exports.RichMessageBuilder = void 0;
exports.richCaption = richCaption;
exports.richTableCell = richTableCell;
exports.richListItem = richListItem;
const richtext_js_1 = require("./richtext.cjs");
...
function richCaption(text, credit) {
    return credit === undefined
        ? { text: (0, richtext_js_1.asRichText)(text) }
        : { text: (0, richtext_js_1.asRichText)(text), credit: (0, richtext_js_1.asRichText)(credit) };
}
/** A table cell; `align` defaults to `"left"`, `valign` to `"top"`. */
function richTableCell(text, options = { align: "left", valign: "top" }) {
    return text === undefined ? { ...options } : { text: (0, richtext_js_1.asRichText)(text), ...options };
}
/** A list item; `blocks` accept a nested builder or callback. */
function richListItem(blocks, options = {}) {
...
class RichMessageBuilder {
    ...
    /** A text paragraph. */
    paragraph(text) {
        return this.push({ type: "paragraph", text: (0, richtext_js_1.asRichText)(text) });
    }
    /** A section heading; `size` is 1 (largest) to 6 (smallest). */
    heading(text, size) {
        return this.push({ type: "heading", text: (0, richtext_js_1.asRichText)(text), size });
    }
    ...
    /** A footer block. */
    footer(text) {
        return this.push({ type: "footer", text: (0, richtext_js_1.asRichText)(text) });
    }
    ...
    blockquote(blocks, credit) {
        return this.push(credit === undefined
            ...
            : { type: "blockquote", blocks: resolveBlocks(blocks), credit: (0, richtext_js_1.asRichText)(credit) });
    }
    /** An expandable (collapsed) block quotation. */
    expandableBlockquote(text, credit) {
        return this.push(credit === undefined
            ? { type: "expandable_blockquote", text: (0, richtext_js_1.asRichText)(text) }
            : { type: "expandable_blockquote", text: (0, richtext_js_1.asRichText)(text), credit: (0, richtext_js_1.asRichText)(credit) });
    }
    /** A pull quotation (centered text). */
    pullQuote(text, credit) {
        return this.push(credit === undefined
            ? { type: "pullquote", text: (0, richtext_js_1.asRichText)(text) }
            : { type: "pullquote", text: (0, richtext_js_1.asRichText)(text), credit: (0, richtext_js_1.asRichText)(credit) });
    }
    ...
    table(cells, options = {}) {
        ...
        return this.push(caption === undefined
            ...
            : { type: "table", cells, ...flags, caption: (0, richtext_js_1.asRichText)(caption) });
    }
    /** A details/disclosure block with an always-shown `summary`. */
    details(summary, blocks, isOpen) {
        return this.push(isOpen === undefined
            ? { type: "details", summary: (0, richtext_js_1.asRichText)(summary), blocks: resolveBlocks(blocks) }
            : {
                type: "details",
                summary: (0, richtext_js_1.asRichText)(summary),
                blocks: resolveBlocks(blocks),
                is_open: isOpen,
            });
    }
    ...
    thinking(text) {
        return this.push({ type: "thinking", text: (0, richtext_js_1.asRichText)(text) });
    }
    /**
...
exports.RichMessageBuilder = RichMessageBuilder;
//# sourceMappingURL=richmessage.cjs.map