...
export declare const REPLY_NAMESPACE = "reply";
 ...
 */
export declare function expectReply(ctx: Context, messageId: number, marker?: ReplyMarker, options?: ExpectOptions): void;
/**
 ...
 */
export declare function matchReply<M extends ReplyMarker = ReplyMarker>(ctx: Context): M | undefined;
/** Forget a pending reply expectation (a prompt that timed out, or was cancelled). */
export declare function forgetReply(ctx: Context, messageId: number): void;
/**
 ...
 */
export declare function expectCallback(ctx: Context, messageId: number, marker?: ReplyMarker, options?: ExpectOptions): void;
/**
 ...
 */
export declare function matchCallback<M extends ReplyMarker = ReplyMarker>(ctx: Context, options?: {
    once?: boolean;
}): M | undefined;
/** Forget a pending press expectation (a keyboard that is no longer live). */
export declare function forgetCallback(ctx: Context, messageId: number): void;
/**
 ...
 */
export declare function taggedReplies<Tag extends string>(ctx: Context): {
...
//# sourceMappingURL=reply-tracking.d.ts.map