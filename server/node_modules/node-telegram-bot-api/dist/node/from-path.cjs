...
const files_js_1 = require("../core/files.cjs");
/**
 ...
 */
async function fromPath(path, meta) {
    await (0, promises_1.stat)(path); // surface a missing/unreadable path here, not mid-request
    const open = () => node_stream_1.Readable.toWeb((0, node_fs_1.createReadStream)(path));
    return new files_js_1.InputFile(open, {
        filename: meta?.filename ?? (0, node_path_1.basename)(path),
        contentType: meta?.contentType,
    });
}
//# sourceMappingURL=from-path.cjs.map