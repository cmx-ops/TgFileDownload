 ...
 */
import type { SessionStore } from "../core/session.cjs";
export type FileSessionStorageOptions = {
    /** Directory to hold the per-key files; created (recursively) by `init()`. */
    path: string;
};
export declare class FileSessionStorage implements SessionStore {
...
//# sourceMappingURL=file-session-storage.d.cts.map