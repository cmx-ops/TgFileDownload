...
exports.nextPagesWebhook = void 0;
exports.nextAppWebhook = nextAppWebhook;
exports.nodeFrameworkWebhook = nodeFrameworkWebhook;
exports.registerExpressWebhook = registerExpressWebhook;
 ...
 * ```
 */
function nextAppWebhook(bot, options) {
    return (0, webhook_js_1.webhookCallback)(bot, options);
}
/**
 ...
 */
function nodeFrameworkWebhook(bot, options) {
    const handle = (0, webhook_js_1.webhookCallback)(bot, options);
