...
import type { SessionStore, SessionWriteOptions } from "../core/session.cjs";
...
export declare class RedisSessionStorage implements SessionStore {
    ...
    write(key: string, value: string, options?: SessionWriteOptions): Promise<void>;
    /**
...
//# sourceMappingURL=redis-storage.d.cts.map